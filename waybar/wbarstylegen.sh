...
export s_fontpx=$(( b_height*42/100 ))   # font size 38% of height
...
killall waybar
waybar -c /home/android-jester/.config/hypr/waybar/config.jsonc -s /home/android-jester/.config/hypr/waybar/style.css > /dev/null 2>&1 &
